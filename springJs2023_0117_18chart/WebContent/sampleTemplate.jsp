	...
	$(function() {
		...
		$('#item2').click(
				function() {
					...
					//이미지 세팅하기
					let imgArr = [ 'a.jpg', 'aa.jpg', 'mylove.jpg' ];
...
<body>
	<header class="text-white text-center">
		...
		<div id="demo" class="carousel slide" data-bs-ride="carousel">
			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<img
						src="${pageContext.request.contextPath}/resources/image/sulli.jpg"
        ...
        ${sessionScope.sessionName }님 반가워요. 조규성 사랑합니다.
        </c:when>
								<c:otherwise>
        jQuery 를 이용하여 제공받은 샘플파일에서 아래 요구사항대로 구현합니다.
				...
				<div class="carousel-item">
					<img
						src="${pageContext.request.contextPath}/resources/image/aa.jpg"
        ...
        안뇽
				...
				<div class="carousel-item">
					<%-- image를 세션값에 따라 메세지 변경해보는 데모 --%>
					<c:choose>
						<c:when test="${sessionScope.sessionName != null}">
							<c:set var="imgv3" value="gs.jpg" scope="page" />
						</c:when>
						<c:otherwise>
							<c:set var="imgv3" value="gsgs.jpg" scope="page" />
						</c:otherwise>
					</c:choose>
					<img
						src="${pageContext.request.contextPath}/resources/image/${imgv3}"
						alt="규성 my love" class="d-block" style="width: 100%">
					<div class="carousel-caption">
						<h3>조규성 강민지 백년해로</h3>
						<p>
							<%-- image를 세션값에 따라 메세지 변경해보는 데모 --%>
	...
	<nav class="navbar navbar-expand-sm mybgColor">
		<div class="container-fluid">
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a
					href="${pageContext.request.contextPath}/upload/upform"
