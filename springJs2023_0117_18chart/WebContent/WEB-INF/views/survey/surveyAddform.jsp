...
<!-- 			<td><input type="text" name="num" id="num"></td></tr> -->
			...
			<tr><th>문항수</th>
			<td><input type="number" name="code" id="code" max="5" min="2" value="2" onchange="increTitle()"></td></tr>
			<tr><th>기본값설정</th>
			<td><input type="number" name="surveycnt" id="surveycnt" max="100" min="0" value="2"></td></tr>
			<tr><th>설문문항1</th>
