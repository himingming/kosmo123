...
<div class="row mb-3">
   ...
   <div class="col-sm-10"><input type="text" name="sub" id="sub" placeholder="제목써라"/></div>
...
<a href="upboardList?cPage=1"><input type="button" value="리스트" id="btn1" class="btn btn-danger"/></a>
 </div>
</div>
</form>
</fieldset>
