			...
			<tbody>
				...
				<c:forEach var="e" items="${list}">
					<tr>
						...
						<td class="align-middle"><a href="upboardList?num=${e.num}">${e.sub }</a></td>
						<td class="align-middle">${e.writer }</td>
						<td><img
							src="${pageContext.request.contextPath}/resources/imgfile/${e.imgn }"></td>
